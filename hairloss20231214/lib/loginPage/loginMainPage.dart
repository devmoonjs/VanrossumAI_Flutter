...
class _TokenCheckState extends State<TokenCheck> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: isToken ? BottomNavi() : LoginPage(),
    );
  }
}
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (loginCheck == '-1') {
                          ...
                          name = (await(getUName(userIdController.text, passwordController.text)))!;
                          UserData.setUserData(userIdController.text, passwordController.text, name);
                          insertLogInLog(userIdController.text);
                          // 자동 로그인 확인
                          if (switchValue == true) {
